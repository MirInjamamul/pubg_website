<?php
	...
	{	
		...
		{
			echo "<center><h3><script>alert('Sorry Wrong Credentials');</script></h3></center>";
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
						<center> <h5 style="font-family: Noto Sans;">Login to </h5><h4 style="font-family: Noto Sans;">GOGARENA</h4></center><br>
