		...
		<div class="container">
			<div class="row">
                <div id="shopping-cart">
                    ...
                    <a id="btnEmpty" href="coc.php?action=empty">Empty Cart</a>
                    <?php
                    ...
                    <?php		
                        foreach ($_SESSION["cart_item"] as $item){
                            ...
                            ?>
                                    ...
                                    <td style="text-align:center;"><a href="coc.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
                                    </tr>
                                    <?php
                    ...
                    <div id="product-grid">
                        ...
                        ?>
                            <div class="product-item">
                                <form method="post" action="coc.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
