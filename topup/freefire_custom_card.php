...
<head>
	<meta charset="UTF-8">
	<title>TOPUP | FREEFIRE CUSTOM CARD</title>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav nav-main">
						...
						<li class="active"><a href="#">TOP-UP</a></li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="products-heading">
						<h2>FREE FIRE (CUSTOM CARD)</h2>
					</div>
				</div>
			</div>
			<div class="row">
                <?php
					$product_array = $db_handle->runQuery("SELECT * FROM tblproduct WHERE code = 'freefire(custom_card)' ORDER BY id ASC");
				...
				<div class="col-md-3">
					<div class="products">
						...
						<?php echo '<a href="productBuy.php?price=' . $price . '&id='.$id.'" class="view-link shutter" >
							BUY</a>' ?>
