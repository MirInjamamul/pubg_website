...
<head>
	<meta charset="UTF-8">
	<title>TOPUP | FREEFIRE PROMO</title>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="products-heading">
						<h2>FREE FIRE (PROMO)</h2>
					</div>
				</div>
			</div>
			<div class="row">
                <?php
					$product_array = $db_handle->runQuery("SELECT * FROM tblproduct WHERE code = 'freefire(promo)' ORDER BY id ASC");
