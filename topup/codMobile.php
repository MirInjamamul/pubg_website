		...
		<div class="container">
			<div class="row">
                <div id="shopping-cart">
                    ...
                    <a id="btnEmpty" href="codMobile.php?action=empty">Empty Cart</a>
                    <?php
                    ...
                    <?php		
                        foreach ($_SESSION["cart_item"] as $item){
                            ...
                            ?>
                                    ...
                                    <td style="text-align:center;"><a href="codMobile.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
                                    </tr>
                                    <?php
                    ...
                    <div id="product-grid">
                        ...
                        <?php
                        $product_array = $db_handle->runQuery("SELECT * FROM tblproduct WHERE code = 'cod' ORDER BY id ASC");
                        if (!empty($product_array)) { 
                            foreach($product_array as $key=>$value){
                        ?>
                            <div class="product-item">
                                <form method="post" action="codMobile.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
