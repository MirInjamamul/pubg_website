...
<head>
	<meta charset="UTF-8">
	<title>TOPUP | FREEFIRE INGAME</title>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="products-heading">
						<h2>FREE FIRE (IN GAME)</h2>
					</div>
				</div>
			</div>
			<div class="row">
                <?php
					$product_array = $db_handle->runQuery("SELECT * FROM tblproduct WHERE code = 'freefire(in_game)' ORDER BY id ASC");
