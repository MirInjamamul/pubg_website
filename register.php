<?php
	...
	{	
		...
		if($password != $confirm_password){
			echo "<center><h3><script>alert('Sorry Password Missmatched');</script></h3></center>";
			...
			{
				$str="insert into user set username='$name',phone='$phone',email='$email',password='$password'";
...
<html>
	<head>
		...
		<title>Register | GOGARENA</title>
		<link rel="stylesheet" href="login_assets/scripts/bootstrap/bootstrap.min.css">
		<link rel="stylesheet" href="login_assets/scripts/ionicons/css/ionicons.min.css">
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;">GOGARENA</h4></center><br>
