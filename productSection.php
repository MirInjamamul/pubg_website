        ...
        <div class="container-fluid">
          ...
          <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="post" action="productSection.php" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-3">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Nothing</label>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Do</label>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Here</label>
                        </div>
                      </div>
                    </div>
                    <button type="submit" class="btn btn-primary pull-right" name="addProduct">Add Product</button>
            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0"> All Product List</h4>
                  <p class="card-category"> All Active Product</p>
                </div>
                <div class="card-body">
                  ...
                  <?php
                            echo '<table class="table">
                                    ...
                                    <tbody>';
                            $count = 1;
                            $result = mysqli_query($con,"SELECT * FROM tblproduct") or die('Error Quiz table Not Table');
